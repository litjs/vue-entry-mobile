    ...
    <div style="height:100%;">
        ...
        <view-box ref="viewBox" :body-padding-top="'46px'" body-padding-bottom="55px">
            ...
            <div style="padding: 15px 15px;" v-show="isShowBar">
                <button-tab>
                    <button-tab-item :selected="true" @click.native="setLocale('zh-CN')">中文</button-tab-item>
                    <button-tab-item :selected="false" @click.native="setLocale('en')">English</button-tab-item>
                </button-tab>
            </div>
            ...
            <tabbar class="vux-demo-tabbar" icon-class="vux-center" v-show="!isTabbarDemo" slot="bottom">
                ...
                <tabbar-item :link="{path:'/demo'}" :selected="isDemo" badge="9">
                    ...
                    <span slot="label"><span v-if="componentName"
                                             class="vux-demo-tabbar-component">{{componentName}}</span><span v-else>Demos</span></span>
                </tabbar-item>
